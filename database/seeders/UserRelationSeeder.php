...
class UserRelationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $userRelations = [
            ...
            // Tedy sebagai owner
            [
                'user_id' => $users['tedy@example.com'],
            ...
            [
                'user_id' => $users['potat@example.com'],
                'relation_id' => $relations['STUDY2025'],
                'is_owner' => false,
            ...
            [
                'user_id' => $users['sari@example.com'],
                'relation_id' => $relations['STUDY2025'],
                'is_owner' => false,
            ...
            [
                'user_id' => $users['budi@example.com'],
                'relation_id' => $relations['STUDY2025'],
                'is_owner' => false,
            ...
            [
                'user_id' => $users['rina@example.com'],
                'relation_id' => $relations['PROJECT01'],
                'is_owner' => false,
                'join_at' => Carbon::now()->subDays(10),
                'created_at' => Carbon::now()->subDays(10),
