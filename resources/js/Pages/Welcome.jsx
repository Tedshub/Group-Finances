                            ...
                            <div className="space-y-4 sm:space-y-6 lg:space-y-7 text-center lg:text-left">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                    {auth?.user ? (
                                        <Link
                                            href="/dashboard"
                                            className={`bg-white text-black px-8 sm:px-10 py-3 sm:py-4 rounded-full font-medium text-base sm:text-lg hover:bg-gray-100 transition-all duration-700 shadow-sm text-center ${
                                        ...
                                        <>
                                            ...
                                            <Link
                                                href="/login"
                                                className={`bg-transparent text-black px-8 sm:px-10 py-3 sm:py-4 rounded-full font-medium text-base sm:text-lg border-2 border-black hover:bg-white transition-all duration-700 text-center ${
                                                    showButtons ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                                                }`}
                                                style={{ transitionDelay: showButtons ? '200ms' : '0ms' }}
                                            >
                                                Masuk
                                            </Link>
                                        </>
